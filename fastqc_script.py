...
# create the command string for each sequence # & implement it
...
# create the command string for each sequence # & implement it
for seq in file_list:
	command = 'trimmomatic ' + seq_dir + '/' + seq
	print(command)
	os.system(command)
...
# mv html & zip files out of sequence directory
# into FASTQC directory
command1 = 'mv ' + seq_dir + '/' + '*.html ' + trimmed_dir 
print(command1)
os.system(command1)
command2 = 'mv ' + seq_dir + '/' + '*.zip ' + trimmed_dir 
print(command2)
os.system(command2)
print('#done')